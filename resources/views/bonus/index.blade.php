            ...
            <div class="page-breadcrumb border-bottom">
                <div class="row">
                    <div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
                        <h5 class="font-medium text-uppercase mb-0">Bonus</h5>
                    </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="material-card card">
                            <div class="card-body">
                                <h4 class="card-title">Liste des Bonus</h4><br>
                                    ...
                                    <table id="liste" class="table table-striped border">
                                        ...
                                        <tbody>
                                           @foreach ($bonus as $bonu)
                                            <tr>
                                                <td>
                                                    {{$bonu->carte->NumeroCarte}}
                                                </td>
                                                <td>
                                                    {{$bonu->carte->client->NomClient}} {{$bonu->carte->client->PrenomClient}}
                                                </td>
                                                <td>
                                                    {{$bonu->CumulPassage}}
                                                </td>

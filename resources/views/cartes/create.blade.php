        ...
        <div class="page-wrapper">
            ...
            <div class="page-content container-fluid">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Formulaire d'inscription d'une noulle carte</h4><br>
                            <form class="" action="{{ route('cartes.store')}}" method="POST" novalidate>
                                @csrf
                                
                                    
                                <div class="form-row">
                                    <div class="col-md-12 mb-3">
                                        <label for="validationCustom">Client</label>
                                        <div class="input-group">
                                            {{-- <input name="client_id" id="validationCustom" class="form-control" aria-describedby="inputGroupPrepend" value="{{ $last_id }}" required> --}}
                                            <select name="client_id" id="validationCustom" class="form-control" aria-describedby="inputGroupPrepend" value="client_id" required>

                    ...
                    <div class="col-lg-9 col-md-8 col-xs-12 align-self-center">
                        <nav aria-label="breadcrumb" class="mt-2 float-md-right float-left">
                            <ol class="breadcrumb mb-0 justify-content-end p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Liste des Rechargements</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="material-card card">
                            <div class="card-body">
                                <h4 class="card-title">Liste des Rechargements
                                        ...
                                        <tbody>
                                           @foreach ($recharges as $recharge)
                                            <tr>
                                                ...
                                                <td>
                                                    {{$recharge->caisse->NomCaisse}}
                                                </td>
                                                <td>
                                                    {{$recharge->caisse->gare->NomGare}}
                                                </td>
                                                <td>
                                                    {{$recharge->created_at->format('d-m-Y')}}
                                                </td>
                                            </tr>
                                            @endforeach

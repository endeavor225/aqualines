        ...
        <div class="page-wrapper">
            ...
            <div class="page-content container-fluid">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Formulaire d'inscription</h4><br>
                            <form class="" action="{{ route('utilisateurs.store')}}" method="POST" novalidate>
                                @csrf
                                <div class="form-row">
                                    <div class="col-md-6 mb-3">
                                        <label for="name">Nom</label>
                                        <input type="text" class="form-control  @error('name') is-invalid @enderror" id="name" placeholder="Nom et Prenon" name="name" value="{{ old('name') }}">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" placeholder="Entrez un email valide" name="email" value="{{ old('email') }}">
